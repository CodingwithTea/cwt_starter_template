...
import 'features/dashboard/core/screens/dashboard/dashboard.dart';
      ...
      bottomNavigationBar: Obx(
        () => NavigationBar(
          ...
          destinations: const [
            ...
            NavigationDestination(icon: Icon(Iconsax.shop), label: 'Dashboard'),
...
class AppScreenController extends GetxController {
  ...
  final screens = [const Dashboard(), Container(), Container(), Container()];
}
