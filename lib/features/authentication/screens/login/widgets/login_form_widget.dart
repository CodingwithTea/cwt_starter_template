...
import '../../email_authenticaltion/forget_password/forget_password_options/forget_password_model_bottom_sheet.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            Align(
              ...
              child: TextButton(onPressed: () => ForgetPasswordScreen.buildShowModalBottomSheet(context), child: const Text(tForgetPassword)),
            ),
